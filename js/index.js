document.addEventListener('DOMContentLoaded', () => {
    fetch('https://rainmachinejs.herokuapp.com/weather/Toronto').then(res => res.json()).then(json => {
    ...
    fetch('https://rainmachinejs.herokuapp.com/weather/Winnipeg').then(res => res.json()).then(json => {
...
function search(e) {
    ...
    fetch(`https://rainmachinejs.herokuapp.com/weather/${val}`).then(res => res.json()).then(json => {
        const rm2 = new RainMachine('.rain-container-2', json)
    })
}